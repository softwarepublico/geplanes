	...
	<body leftmargin="0" topmargin="0" style="padding:0px" bgColor="#FFFFFF" style="background-color: #FFFFFF;overflow:hidden;">
		<n:form validate="true">
		 ...
		 <table class="lookup_janela">
			<TR>
				<TD class="fd_tela_titulo" style="height: 20px;" >Solicitação de cancelamento de indicador</TD>
			</TR>
			<TR>
				<TD valign="top">
					<n:bean name="solicitacaoCancelamentoIndicador">
						...
						<t:propertyConfig showLabel="true" renderAs="double">	
							...
							<t:janelaResultados>
								...
								<div align="right" style="padding-top:20px;padding-right:20px;">
									<n:submit url="/sgm/process/SolicitacaoCancelamentoIndicador" action="cancelamentoPorLancamento" class="botao_normal">Salvar</n:submit>
								</div>
							</t:janelaResultados>
						</t:propertyConfig>
					</n:bean>			
