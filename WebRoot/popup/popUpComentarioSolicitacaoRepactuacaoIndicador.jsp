						...
						<TR>
							<TD valign="top">
								<n:bean name="comentarioitem">
									<t:property name="solicitacaoRepactuacaoIndicador" mode="input" type="hidden" showLabel="false"/>
									...
									<t:propertyConfig showLabel="true" renderAs="double">	
										<t:janelaResultados>
											...
											<div align="right" style="padding-right:20px;">
												<n:submit url="/sgm/process/SolicitacaoRepactuacaoIndicador" action="incluirComentario" class="botao_normal">Incluir</n:submit>
											</div>
										</t:janelaResultados>
									</t:propertyConfig>
								</n:bean>			
