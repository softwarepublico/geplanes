...
<t:tela titulo="Solicitação de repactuação de indicador">
	<t:janelaFiltro>
		...
		<t:tabelaFiltro>
			...
			<n:panel>				
				...
				<t:propertyConfig showLabel="false" >
					<n:dataGrid property="listaSolicitacaoRepactuacaoIndicador" var="sol" headerStyleClass="txt_tit" bodyStyleClasses="txt_l1, txt_l2" styleClass="fd_tabela1">
						<n:column header="U.G.">
...
<script type="text/javascript">
	...
	function popUpComentario(solicitacaoID) {
	    ...
	    var left = 99;
	    var top = 99;
	    window.open('${ctx}/sgm/process/SolicitacaoRepactuacaoIndicador?ACAO=popUpComentario&solicitacaoID='+solicitacaoID+'','comentario', 'width='+width+', height='+height+', top='+top+', left='+left+', scrollbars=yes, status=no, toolbar=no, location=no, directories=no, menubar=no, resizable=no, fullscreen=no');
	}
</script>