 ...
 */
@Bean
@Controller(path="/sgm/report/AnomaliaListagem", authorizationModule=ReportAuthorizationModule.class)
public class AnomaliaListagemReport extends GeplanesReport<AnomaliaListagemReportFiltro>{
	...
	@Override
	@Action("gerar")
	public IReport createReportGeplanes(WebRequestContext request, AnomaliaListagemReportFiltro filtro) throws Exception {
		return anomaliaService.createAnomaliaListagemReport(filtro);
	}
	
	@Override
	@DefaultAction
	public ModelAndView doFiltro(WebRequestContext request,AnomaliaListagemReportFiltro filtro)throws ResourceGenerationException {
