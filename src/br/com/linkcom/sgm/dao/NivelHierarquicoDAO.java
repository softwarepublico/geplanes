...
public class NivelHierarquicoDAO extends GenericDAO<NivelHierarquico> {
	
	@Override
	public void updateListagemQuery(QueryBuilder<NivelHierarquico> query,FiltroListagem _filtro) {
		NivelHierarquicoFiltro filtro = (NivelHierarquicoFiltro) _filtro;
