...
public class AnexoIndicadorDAO extends GenericDAO<AnexoIndicador> {
	...
	public List<AnexoIndicador> findByIndicador(Indicador indicador) {	
		return query()
			.leftOuterJoin("anexoIndicador.indicador indicador")
			.joinFetch("anexoIndicador.arquivo")
	...
	@Override
	public void delete(final AnexoIndicador bean) {
		getTransactionTemplate().execute(new TransactionCallback(){
			public Object doInTransaction(TransactionStatus arg0) {
				AnexoIndicadorDAO.super.delete(bean);
				return null;
			}});
