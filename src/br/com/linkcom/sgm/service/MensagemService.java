...
import br.com.linkcom.sgm.dao.MensagemDAO;
...
public class MensagemService extends GenericService<Mensagem> {
	...
	public List<Mensagem> listaVisiveis() {
		List<Mensagem> v = mensagemDAO.listaVisiveis();
		
		SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");
		for (Mensagem mensagem : v) {
			String data = dateFormat.format(mensagem.getDataLancamento());
			mensagem.setDataLancamentoFormatada(data);
		}
