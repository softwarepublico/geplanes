...
import br.com.linkcom.sgm.dao.AtividadeDAO;
...
public class AtividadeService extends GenericService<Atividade> {
	...
	public void setAtividadeDAO(AtividadeDAO atividadeDAO) {this.atividadeDAO = atividadeDAO;}
	
	/**
	 * Faz referência ao DAO.
	 * 
	 * @see br.com.linkcom.sgm.dao.AtividadeDAO#findByMapaCompetencia
	 * 
	...
	public List<Atividade> findByMapaCompetencia(MapaCompetencia mapaCompetencia) {
		return atividadeDAO.findByMapaCompetencia(mapaCompetencia);
	}
