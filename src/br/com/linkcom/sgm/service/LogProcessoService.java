...
import br.com.linkcom.sgm.dao.LogProcessoDAO;

public class LogProcessoService extends GenericService<LogProcesso> {
	...
	public LogProcesso getLogProcessoAtual() {
		return logProcessoDAO.getLogProcessoAtual();
	}
}
